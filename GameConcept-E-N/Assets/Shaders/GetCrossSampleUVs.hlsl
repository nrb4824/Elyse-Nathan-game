...
//void GetNearbyEdges_float(float Val, float2 TexelSize, float OutlineThickness,
//	out float Out) {
//
//	float TR;
//	float BL;
...
//		if (Val > .5) {
//			TR = Val + float2(TexelSize.x, TexelSize.y) * i;
//			TR = Val - float2(TexelSize.x, TexelSize.y) * i;
//			TR = Val + float2(-TexelSize.x * i, TexelSize.y * i);
//			TR = Val + float2(TexelSize.x * i, -TexelSize.y * i);
//		}
//	}
//
