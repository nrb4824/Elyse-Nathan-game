...
public class WallRunning : MonoBehaviour
{
    ...
    {
        wallRight = Physics.Raycast(transform.position, orientation.right, out rightWallhit, wallCheckDistance, whatIsWall);  //Physics.Raycast(start point, direction, store hit info, distance, wall Layer Mask)
    ...
    private void WallJump()
    {
        ...
        rb.velocity = new Vector3(rb.velocity.x, 0f, rb.velocity.z);  //Resets y velocity before jump (good practice)
